import { __privateAdd, __publicField, __privateMethod, __privateGet, __privateSet } from './chunk-VGP27YFB.js';
...
function CustomMediaMixin(superclass, { tag, is }) {
  ...
  }, __privateAdd(_a, _CustomMedia_static), __publicField(_a, "getTemplateHTML", tag.endsWith("audio") ? getAudioTemplateHTML : getVideoTemplateHTML), __publicField(_a, "shadowRootOptions", { mode: "open" }), __publicField(_a, "Events", Events), __privateAdd(_a, _isDefined, false), _a;
}
...
export { CustomVideoElement, MediaTracksMixin };
//# sourceMappingURL=chunk-BRQJKEKY.js.map
//# sourceMappingURL=chunk-BRQJKEKY.js.map